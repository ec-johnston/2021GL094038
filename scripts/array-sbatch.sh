...
#SBATCH --error=/oak/stanford/groups/*******/group_members/***/landslide_felm_PRISM/felm_01d/pacificCoast_states/main/felm_boot_%a.err
#SBATCH --output=/oak/stanford/groups/*******/group_members/***/landslide_felm_PRISM/felm_01d/pacificCoast_states/main/felm_boot_%a.out
...
cd /oak/stanford/groups/*******/group_members/***/landslide_felm_PRISM/felm_01d/pacificCoast_states/main/
