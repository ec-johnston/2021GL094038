...
Reduced data for the US Pacific Coast region at 4 km spatial resolution (some data not included due to size): 
...
- daily_precip_2009_2017.rds: daily precipitation data from PRISM 
